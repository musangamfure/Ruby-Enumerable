...
Clone this repository to your desired folder: ` @https://github.com/musangamfure/Ruby-Enumerable/edit/Create-your-own-Enumerable.git `
...
To run tests, run the following command: `  run ruby enumerable.rd `
...
Feel free to check the [issues page](https://github.com/musangamfure/Ruby-Enumerable/edit/Create-your-own-Enumerable/issues).
...
This project is [MIT](https://github.com/musangamfure/Ruby-Enumerable/blob/dev/LICENSE) licensed.
